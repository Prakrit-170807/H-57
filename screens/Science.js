  ...
  render() {
    return (
      <View style={styles.container}>
        ...
        <Text style={styles.points}> 1.                                                      The axis of the Earth is tilted at an angle of 23.44 degrees.</Text>
        <TouchableOpacity style={{ marginBottom: 70 }}>
        </TouchableOpacity>
        <Text style={styles.points}>2.                                                    Elephants stay pregnant for 22 months.</Text>
